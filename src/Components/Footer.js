                ...
                <div className="container-fluid">
                    ...
                    <div className="col-lg-3 offset-lg-2">
                        ...
                        <div className="footer-widget-texts">
                            ...
                            <Link to="#" onClick={() => window.open("https://www.facebook.com/bdcrictime")}><img src={FacebookIcon} alt="" /></Link>
                            <Link to="#" onClick={() => window.open("https://www.twitter.com/bdcrictime")}><img src={TwitterIcon} alt="" /></Link>
                            <Link to="#" onClick={() => window.open("https://www.instagram.com/bdcrictime")}><img src={InstagramIcon} alt="" /></Link>
                            <Link to="#"><img src={PinterestIcon} alt="" /></Link>
                            </div>
